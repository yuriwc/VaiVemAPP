...
const App = ({navigation}: any) => {
  const [, setUserInfo] = useState([] as any);
  ...
  async function configureGoogleSign() {
    if (Platform.OS === 'android') {
      await GoogleSignin.configure({
        webClientId:
          '806189079871-dk8lfs35ijanetu335mdvfgktuklgoe6.apps.googleusercontent.com',
        offlineAccess: true,
      });
    } else {
      await GoogleSignin.configure({
        webClientId:
          '806189079871-80vocopfrh3fh957drg6nr9dfgv3pdis.apps.googleusercontent.com',
    ...
    <SafeAreaView style={[backgroundStyle, styles.safeContainer]}>
      ...
      <View style={[backgroundStyle, styles.container]}>
        ...
        <Text
          ...
          Seja bem vindo. Faça o login para continuar.
        </Text>
